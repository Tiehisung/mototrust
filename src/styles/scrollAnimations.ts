// styles/animations.css or in your global CSS
export const animationStyles = `
  ...
  .reveal-on-scroll.in-view.reveal-left,
  .reveal-on-scroll.in-view.reveal-right,
  .reveal-on-scroll.in-view.reveal-scale {
  ...
  #scroll-progress {
    ...
    width: 100%;
    height: 3px;
    background: var(--brand-color, #ff6b35);
